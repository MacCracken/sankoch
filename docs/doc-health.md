...
| `VERSION` | 2026-07-19 | ✅ Fresh | `2.5.9`. Single source of truth per the standards. |
...
| `2026-07-19-pre-2.6.0.md` | 2026-07-19 | 🔵 Dated artifact (2.5.9 P(-1) — **first audit of the never-audited 2.4.x/2.5.x surface**; 1 HIGH + 13 MEDIUM + 5 LOW; security-critical subset fixed in 2.5.9, remainder → 2.5.10; INFO-E resolved negative. Carries a post-audit remediation-status section) |
