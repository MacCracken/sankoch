...
> **Last refresh**: 2026-07-18 (**2.5.7 cut — zstd encoder parse quality**; VERSION / CHANGELOG / state / roadmap bumped to 2.5.7, source re-counted [zstd.cyr 1,798→1,992; total 12,779; full bundle 12,761], test totals 265 fns / 4,483,989, new benchmark doc `2026-07-18-2.5.7-parse-quality.md`, roadmap 2.5.7 shipped + 2.5.8 optional optimal parse; fixed a CHANGELOG bug — the `[2.5.6]` header had been dropped during a 2.5.7 bite, merging its content into `[Unreleased]`; restored) | **Refresh cadence**: opportunistic — update the affected row whenever a doc is touched.
>
...
| `VERSION` | 2026-07-18 | ✅ Fresh | `2.5.7`. Single source of truth per the standards. |
