...
> **Last refresh**: 2026-05-23 (v2.3.0 cut — first-party-standards conformance sweep + doc-health scaffold) | **Refresh cadence**: opportunistic — update the affected row whenever a doc is touched.
>
...
| `CHANGELOG.md` | 2026-05-23 | ✅ Fresh | **Source of truth per CLAUDE.md.** Through `[2.3.0] — 2026-05-23`. Empty `[Unreleased]` header at top per Keep-a-Changelog convention. |
...
| `VERSION` | 2026-05-23 | ✅ Fresh | `2.3.0`. Single source of truth per the standards. |
| `cyrius.cyml` | 2026-05-19 | ✅ Fresh | Toolchain pin `cyrius = "6.0.1"`. |
...
| File | Last touched | Status | Notes |
|---|---|---|---|
| `roadmap.md` | 2026-05-23 | ✅ Fresh | **Trimmed 2026-05-23**: 746 lines → 273 lines. Removed all shipped ✅ entries (now in CHANGELOG); kept forward ladder (2.3.1 / 2.3.2 / 2.3.3 / 2.3.4 P(-1) closeout). New `2.3.3 streaming-decode hardening` slot rolls up deferred 2.3.0 items + carried INFOs. |
| `state.md` | 2026-05-23 | ✅ Fresh | **NEW 2026-05-23.** Live state snapshot — version, source lines, test/assertion counts, distlib sizes, in-flight slots, consumers, distribution targets. Refreshes every release. |
